...
import CanteenMapScreen from './screens/CanteenMapScreen';
  ...
  return (
    <NavigationContainer>
      ...
      <Stack.Navigator initialRouteName="Search">
        ...
        <Stack.Screen name="Canteen" component={CanteenScreen} options={{ title: 'Kantine' }} />
        <Stack.Screen name="CanteenMenu" component={CanteenMenuScreen} options={{ title: 'Kantine – Menu' }} />
        <Stack.Screen name="CanteenMap" component={CanteenMapScreen} options={{ title: 'Kantine – Kort' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
